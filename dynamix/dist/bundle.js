...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "readKeys", function() { return readKeys; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "monsterCanvas", function() { return monsterCanvas; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "monsterCtx", function() { return monsterCtx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "partCanvas", function() { return partCanvas; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "partCtx", function() { return partCtx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "translatedCanvas", function() { return translatedCanvas; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "translatedCtx", function() { return translatedCtx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "vawes", function() { return vawes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "configIndx", function() { return configIndx; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "indxTemp", function() { return indxTemp; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "configController", function() { return configController; });
/* harmony export (immutable) */ __webpack_exports__["default"] = getRandom;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_player_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__classes_monster_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__classes_configController_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__jquery_3_1_1_min_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__jquery_3_1_1_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__jquery_3_1_1_min_js__);
...
__WEBPACK_IMPORTED_MODULE_3__jquery_3_1_1_min_js___default()(document).ready(() => {
    getCanvases();
    resizeCanvas(canvas);
    resizeCanvas(monsterCanvas);
    player = new __WEBPACK_IMPORTED_MODULE_0__classes_player_js__["a" /* default */](PLAYER_ICON, ctx, canvas, 100, canvas.height/2, 20);
    monster = new __WEBPACK_IMPORTED_MODULE_1__classes_monster_js__["a" /* default */](MONSTER_ICON, AUDIO_URL, CLIENT_ID, monsterCtx, monsterCanvas, player);
    configController = new __WEBPACK_IMPORTED_MODULE_2__classes_configController_js__["a" /* default */](partCanvas, partCtx, translatedCanvas, translatedCtx, player);
    startTime = Date.now();
...
__WEBPACK_IMPORTED_MODULE_3__jquery_3_1_1_min_js___default()(window).resize(() => {
    location.reload();
});

__WEBPACK_IMPORTED_MODULE_3__jquery_3_1_1_min_js___default()(document).keydown((e) => {
    switch(e.keyCode) {
        case 65: {
...
__WEBPACK_IMPORTED_MODULE_3__jquery_3_1_1_min_js___default()(document).keyup((e) => {
    switch(e.keyCode) {
        case 65: {
            ...
            player.stopAnimation();
            __WEBPACK_IMPORTED_MODULE_3__jquery_3_1_1_min_js___default()(document).keydown();
            break;
        }
        case 87: { 
            readKeys -= player.upMark;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mainActions_js__ = __webpack_require__(0);
...
class Player {
    ...
    checkCollision(particles, isTranslated) {
        let line = Math.sqrt(Math.pow((this.initialX - __WEBPACK_IMPORTED_MODULE_0__mainActions_js__["monster"].canvas.width/2), 2) + Math.pow((this.initialY - __WEBPACK_IMPORTED_MODULE_0__mainActions_js__["monster"].canvas.height/2), 2)),
            monsterHornsSize = 56,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__particle_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mainActions_js__ = __webpack_require__(0);
...
class ConfigController {
    ...
    render(config) {
        ...
        let particles = this.createParticles(Object(__WEBPACK_IMPORTED_MODULE_1__mainActions_js__["default"])(config.min, config.max));
        switch(config.type) {
            case 'CIRCLE-FLIGHT': {
    ...
    createParticles(amount) {
        ...
        for (let i = 0; i < amount; i++) {
            buff.push(new __WEBPACK_IMPORTED_MODULE_0__particle_js__["a" /* default */](5, 50));
        }
        return buff;
    ...
    circleFlight(particles) {
        ...
        let self = this,
            bump,
            speed = Object(__WEBPACK_IMPORTED_MODULE_1__mainActions_js__["default"])(5,8),
            radius = 0,
    ...
    randomFlight(particles) {
        ...
        for (let i = 0; i < particles.length; i++) {
            particles[i].x = canvas.width/2;
            particles[i].y = canvas.height/2;
            particles[i].randomCoordX = Object(__WEBPACK_IMPORTED_MODULE_1__mainActions_js__["default"])(0, canvas.width);
            particles[i].randomCoordY = Object(__WEBPACK_IMPORTED_MODULE_1__mainActions_js__["default"])(0, canvas.height);
    ...
    wallFlight(particles) {
        ...
        for (let i = 0; i < particles.length; i++) {
            ...
            particles[i].speed = Object(__WEBPACK_IMPORTED_MODULE_1__mainActions_js__["default"])(5, 7);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ConfigController;
...
class Particle {
    ...
    constructor(minRad, maxRad) {
        ...
        this.radius = Math.ceil(Object(__WEBPACK_IMPORTED_MODULE_0__mainActions_js__["default"])(this.minRadius, this.maxRadius));
        this.color = this.colors[Math.floor(Object(__WEBPACK_IMPORTED_MODULE_0__mainActions_js__["default"])(0, this.colors.length))];
    }
